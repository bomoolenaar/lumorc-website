...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Em(s,e,t){const n=new Float32Array(ti),i=new N(0,1,0);return new pn({name:"SphericalGaussianBlur",defines:{n:ti,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:cr(),fragmentShader:`
...
}`,u_=[new N(1,0,0),new N(-1,0,0),new N(0,1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1)],d_=[new N(0,-1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1),new N(0,-1,0),new N(0,-1,0)],ql=new ze,Ki=new N,Kr=new N;function f_(s,e,t){let n=new fo;const i=new Xe,r=new Xe,a=new ct,o=new Qu,l=new ed,c={},h=t.maxTextureSize,u={[Rn]:Ot,[Ot]:Rn,[an]:an},d=new pn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Xe},radius:{value:4}},vertexShader:c_,fragmentShader:h_}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new Ct;g.setAttribute("position",new yt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Nt(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=qs;let p=this.type;this.render=function(w,R,U){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;w.type===vh&&(Te("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),w.type=qs);const v=s.getRenderTarget(),y=s.getActiveCubeFace(),P=s.getActiveMipmapLevel(),G=s.state;G.setBlending(An),G.buffers.depth.getReversed()===!0?G.buffers.color.setClear(0,0,0,0):G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const V=p!==this.type;V&&R.traverse(function(Y){Y.material&&(Array.isArray(Y.material)?Y.material.forEach(H=>H.needsUpdate=!0):Y.material.needsUpdate=!0)});for(let Y=0,H=w.length;Y<H;Y++){const O=w[Y],B=O.shadow;if(B===void 0){Te("WebGLShadowMap:",O,"has no shadow.");continue}if(B.autoUpdate===!1&&B.needsUpdate===!1)continue;i.copy(B.mapSize);const $=B.getFrameExtents();if(i.multiply($),r.copy(B.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/$.x),i.x=r.x*$.x,B.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/$.y),i.y=r.y*$.y,B.mapSize.y=r.y)),B.map===null||V===!0){if(B.map!==null&&(B.map.depthTexture!==null&&(B.map.depthTexture.dispose(),B.map.depthTexture=null),B.map.dispose()),this.type===Zi){if(O.isPointLight){Te("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}B.map=new hn(i.x,i.y,{format:Ri,type:Cn,minFilter:St,magFilter:St,generateMipmaps:!1}),B.map.texture.name=O.name+".shadowMap",B.map.depthTexture=new hs(i.x,i.y,Yt),B.map.depthTexture.name=O.name+".shadowMapDepth",B.map.depthTexture.format=Pn,B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=vt,B.map.depthTexture.magFilter=vt}else{O.isPointLight?(B.map=new Uc(i.x),B.map.depthTexture=new Zu(i.x,dn)):(B.map=new hn(i.x,i.y),B.map.depthTexture=new hs(i.x,i.y,dn)),B.map.depthTexture.name=O.name+".shadowMap",B.map.depthTexture.format=Pn;const re=s.state.buffers.depth.getReversed();this.type===qs?(B.map.depthTexture.compareFunction=re?ro:so,B.map.depthTexture.minFilter=St,B.map.depthTexture.magFilter=St):(B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=vt,B.map.depthTexture.magFilter=vt)}B.camera.updateProjectionMatrix()}const he=B.map.isWebGLCubeRenderTarget?6:1;for(let re=0;re<he;re++){if(B.map.isWebGLCubeRenderTarget)s.setRenderTarget(B.map,re),s.clear();else{re===0&&(s.setRenderTarget(B.map),s.clear());const Q=B.getViewport(re);a.set(r.x*Q.x,r.y*Q.y,r.x*Q.z,r.y*Q.w),G.viewport(a)}if(O.isPointLight){const Q=B.camera,xe=B.matrix,Ee=O.distance||Q.far;Ee!==Q.far&&(Q.far=Ee,Q.updateProjectionMatrix()),Ki.setFromMatrixPosition(O.matrixWorld),Q.position.copy(Ki),Kr.copy(Q.position),Kr.add(u_[re]),Q.up.copy(d_[re]),Q.lookAt(Kr),Q.updateMatrixWorld(),xe.makeTranslation(-Ki.x,-Ki.y,-Ki.z),ql.multiplyMatrices(Q.projectionMatrix,Q.matrixWorldInverse),B._frustum.setFromProjectionMatrix(ql,Q.coordinateSystem,Q.reversedDepth)}else B.updateMatrices(O);n=B.getFrustum(),b(R,U,B.camera,O,this.type)}B.isPointLightShadow!==!0&&this.type===Zi&&E(B,U),B.needsUpdate=!1}p=this.type,m.needsUpdate=!1,s.setRenderTarget(v,y,P)};function E(w,R){const U=e.update(x);d.defines.VSM_SAMPLES!==w.blurSamples&&(d.defines.VSM_SAMPLES=w.blurSamples,f.defines.VSM_SAMPLES=w.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new hn(i.x,i.y,{format:Ri,type:Cn})),d.uniforms.shadow_pass.value=w.map.depthTexture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,s.setRenderTarget(w.mapPass),s.clear(),s.renderBufferDirect(R,null,U,d,x,null),f.uniforms.shadow_pass.value=w.mapPass.texture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,s.setRenderTarget(w.map),s.clear(),s.renderBufferDirect(R,null,U,f,x,null)}function M(w,R,U,v){let y=null;const P=U.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(P!==void 0)y=P;else if(y=U.isPointLight===!0?l:o,s.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const G=y.uuid,V=R.uuid;let Y=c[G];Y===void 0&&(Y={},c[G]=Y);let H=Y[V];H===void 0&&(H=y.clone(),Y[V]=H,R.addEventListener("dispose",A)),y=H}if(y.visible=R.visible,y.wireframe=R.wireframe,v===Zi?y.side=R.shadowSide!==null?R.shadowSide:R.side:y.side=R.shadowSide!==null?R.shadowSide:u[R.side],y.alphaMap=R.alphaMap,y.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,y.map=R.map,y.clipShadows=R.clipShadows,y.clippingPlanes=R.clippingPlanes,y.clipIntersection=R.clipIntersection,y.displacementMap=R.displacementMap,y.displacementScale=R.displacementScale,y.displacementBias=R.displacementBias,y.wireframeLinewidth=R.wireframeLinewidth,y.linewidth=R.linewidth,U.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const G=s.properties.get(y);G.light=U}return y}function b(w,R,U,v,y){if(w.visible===!1)return;if(w.layers.test(R.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&y===Zi)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(U.matrixWorldInverse,w.matrixWorld);const V=e.update(w),Y=w.material;if(Array.isArray(Y)){const H=V.groups;for(let O=0,B=H.length;O<B;O++){const $=H[O],he=Y[$.materialIndex];if(he&&he.visible){const re=M(w,he,v,y);w.onBeforeShadow(s,w,R,U,V,re,$),s.renderBufferDirect(U,null,V,re,w,$),w.onAfterShadow(s,w,R,U,V,re,$)}}}else if(Y.visible){const H=M(w,Y,v,y);w.onBeforeShadow(s,w,R,U,V,H,null),s.renderBufferDirect(U,null,V,H,w,null),w.onAfterShadow(s,w,R,U,V,H,null)}}const G=w.children;for(let V=0,Y=G.length;V<Y;V++)b(G[V],R,U,v,y)}function A(w){w.target.removeEventListener("dispose",A);for(const U in c){const v=c[U],y=w.target.uuid;y in v&&(v[y].dispose(),delete v[y])}}}const p_={[ea]:ta,[na]:ra,[ia]:aa,[Ti]:sa,[ta]:ea,[ra]:na,[aa]:ia,[sa]:Ti};function m_(s,e){function t(){let L=!1;const le=new ct;let te=null;const de=new ct(0,0,0,0);return{setMask:function(ee){te!==ee&&!L&&(s.colorMask(ee,ee,ee,ee),te=ee)},setLocked:function(ee){L=ee},setClear:function(ee,K,se,Pe,Qe){Qe===!0&&(ee*=Pe,K*=Pe,se*=Pe),le.set(ee,K,se,Pe),de.equals(le)===!1&&(s.clearColor(ee,K,se,Pe),de.copy(le))},reset:function(){L=!1,te=null,de.set(-1,0,0,0)}}}function n(){let L=!1,le=!1,te=null,de=null,ee=null;return{setReversed:function(K){if(le!==K){const se=e.get("EXT_clip_control");K?se.clipControlEXT(se.LOWER_LEFT_EXT,se.ZERO_TO_ONE_EXT):se.clipControlEXT(se.LOWER_LEFT_EXT,se.NEGATIVE_ONE_TO_ONE_EXT),le=K;const Pe=ee;ee=null,this.setClear(Pe)}},getReversed:function(){return le},setTest:function(K){K?Z(s.DEPTH_TEST):me(s.DEPTH_TEST)},setMask:function(K){te!==K&&!L&&(s.depthMask(K),te=K)},setFunc:function(K){if(le&&(K=p_[K]),de!==K){switch(K){case ea:s.depthFunc(s.NEVER);break;case ta:s.depthFunc(s.ALWAYS);break;case na:s.depthFunc(s.LESS);break;case Ti:s.depthFunc(s.LEQUAL);break;case ia:s.depthFunc(s.EQUAL);break;case sa:s.depthFunc(s.GEQUAL);break;case ra:s.depthFunc(s.GREATER);break;case aa:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}de=K}},setLocked:function(K){L=K},setClear:function(K){ee!==K&&(le&&(K=1-K),s.clearDepth(K),ee=K)},reset:function(){L=!1,te=null,de=null,ee=null,le=!1}}}function i(){let L=!1,le=null,te=null,de=null,ee=null,K=null,se=null,Pe=null,Qe=null;return{setTest:function($e){L||($e?Z(s.STENCIL_TEST):me(s.STENCIL_TEST))},setMask:function($e){le!==$e&&!L&&(s.stencilMask($e),le=$e)},setFunc:function($e,_t,_n){(te!==$e||de!==_t||ee!==_n)&&(s.stencilFunc($e,_t,_n),te=$e,de=_t,ee=_n)},setOp:function($e,_t,_n){(K!==$e||se!==_t||Pe!==_n)&&(s.stencilOp($e,_t,_n),K=$e,se=_t,Pe=_n)},setLocked:function($e){L=$e},setClear:function($e){Qe!==$e&&(s.clearStencil($e),Qe=$e)},reset:function(){L=!1,le=null,te=null,de=null,ee=null,K=null,se=null,Pe=null,Qe=null}}}const r=new t,a=new n,o=new i,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,f=[],g=null,x=!1,m=null,p=null,E=null,M=null,b=null,A=null,w=null,R=new De(0,0,0),U=0,v=!1,y=null,P=null,G=null,V=null,Y=null;const H=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,B=0;const $=s.getParameter(s.VERSION);$.indexOf("WebGL")!==-1?(B=parseFloat(/^WebGL (\d)/.exec($)[1]),O=B>=1):$.indexOf("OpenGL ES")!==-1&&(B=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),O=B>=2);let he=null,re={};const Q=s.getParameter(s.SCISSOR_BOX),xe=s.getParameter(s.VIEWPORT),Ee=new ct().fromArray(Q),Ve=new ct().fromArray(xe);function He(L,le,te,de){const ee=new Uint8Array(4),K=s.createTexture();s.bindTexture(L,K),s.texParameteri(L,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(L,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let se=0;se<te;se++)L===s.TEXTURE_3D||L===s.TEXTURE_2D_ARRAY?s.texImage3D(le,0,s.RGBA,1,1,de,0,s.RGBA,s.UNSIGNED_BYTE,ee):s.texImage2D(le+se,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,ee);return K}const X={};X[s.TEXTURE_2D]=He(s.TEXTURE_2D,s.TEXTURE_2D,1),X[s.TEXTURE_CUBE_MAP]=He(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),X[s.TEXTURE_2D_ARRAY]=He(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),X[s.TEXTURE_3D]=He(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),Z(s.DEPTH_TEST),a.setFunc(Ti),Ne(!1),dt(Io),Z(s.CULL_FACE),Ke(An);function Z(L){h[L]!==!0&&(s.enable(L),h[L]=!0)}function me(L){h[L]!==!1&&(s.disable(L),h[L]=!1)}function Ce(L,le){return u[L]!==le?(s.bindFramebuffer(L,le),u[L]=le,L===s.DRAW_FRAMEBUFFER&&(u[s.FRAMEBUFFER]=le),L===s.FRAMEBUFFER&&(u[s.DRAW_FRAMEBUFFER]=le),!0):!1}function ve(L,le){let te=f,de=!1;if(L){te=d.get(le),te===void 0&&(te=[],d.set(le,te));const ee=L.textures;if(te.length!==ee.length||te[0]!==s.COLOR_ATTACHMENT0){for(let K=0,se=ee.length;K<se;K++)te[K]=s.COLOR_ATTACHMENT0+K;te.length=ee.length,de=!0}}else te[0]!==s.BACK&&(te[0]=s.BACK,de=!0);de&&s.drawBuffers(te)}function Ye(L){return g!==L?(s.useProgram(L),g=L,!0):!1}const ot={[ei]:s.FUNC_ADD,[Mh]:s.FUNC_SUBTRACT,[yh]:s.FUNC_REVERSE_SUBTRACT};ot[bh]=s.MIN,ot[Eh]=s.MAX;const Fe={[Th]:s.ZERO,[Ah]:s.ONE,[wh]:s.SRC_COLOR,[Jr]:s.SRC_ALPHA,[Dh]:s.SRC_ALPHA_SATURATE,[Lh]:s.DST_COLOR,[Ch]:s.DST_ALPHA,[Rh]:s.ONE_MINUS_SRC_COLOR,[Qr]:s.ONE_MINUS_SRC_ALPHA,[Ih]:s.ONE_MINUS_DST_COLOR,[Ph]:s.ONE_MINUS_DST_ALPHA,[Nh]:s.CONSTANT_COLOR,[Uh]:s.ONE_MINUS_CONSTANT_COLOR,[Fh]:s.CONSTANT_ALPHA,[Oh]:s.ONE_MINUS_CONSTANT_ALPHA};function Ke(L,le,te,de,ee,K,se,Pe,Qe,$e){if(L===An){x===!0&&(me(s.BLEND),x=!1);return}if(x===!1&&(Z(s.BLEND),x=!0),L!==Sh){if(L!==m||$e!==v){if((p!==ei||b!==ei)&&(s.blendEquation(s.FUNC_ADD),p=ei,b=ei),$e)switch(L){case yi:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Do:s.blendFunc(s.ONE,s.ONE);break;case No:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Uo:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:Ie("WebGLState: Invalid blending: ",L);break}else switch(L){case yi:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Do:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case No:Ie("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Uo:Ie("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ie("WebGLState: Invalid blending: ",L);break}E=null,M=null,A=null,w=null,R.set(0,0,0),U=0,m=L,v=$e}return}ee=ee||le,K=K||te,se=se||de,(le!==p||ee!==b)&&(s.blendEquationSeparate(ot[le],ot[ee]),p=le,b=ee),(te!==E||de!==M||K!==A||se!==w)&&(s.blendFuncSeparate(Fe[te],Fe[de],Fe[K],Fe[se]),E=te,M=de,A=K,w=se),(Pe.equals(R)===!1||Qe!==U)&&(s.blendColor(Pe.r,Pe.g,Pe.b,Qe),R.copy(Pe),U=Qe),m=L,v=!1}function Je(L,le){L.side===an?me(s.CULL_FACE):Z(s.CULL_FACE);let te=L.side===Ot;le&&(te=!te),Ne(te),L.blending===yi&&L.transparent===!1?Ke(An):Ke(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),a.setFunc(L.depthFunc),a.setTest(L.depthTest),a.setMask(L.depthWrite),r.setMask(L.colorWrite);const de=L.stencilWrite;o.setTest(de),de&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),ft(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?Z(s.SAMPLE_ALPHA_TO_COVERAGE):me(s.SAMPLE_ALPHA_TO_COVERAGE)}function Ne(L){y!==L&&(L?s.frontFace(s.CW):s.frontFace(s.CCW),y=L)}function dt(L){L!==_h?(Z(s.CULL_FACE),L!==P&&(L===Io?s.cullFace(s.BACK):L===xh?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):me(s.CULL_FACE),P=L}function C(L){L!==G&&(O&&s.lineWidth(L),G=L)}function ft(L,le,te){L?(Z(s.POLYGON_OFFSET_FILL),(V!==le||Y!==te)&&(s.polygonOffset(le,te),V=le,Y=te)):me(s.POLYGON_OFFSET_FILL)}function je(L){L?Z(s.SCISSOR_TEST):me(s.SCISSOR_TEST)}function st(L){L===void 0&&(L=s.TEXTURE0+H-1),he!==L&&(s.activeTexture(L),he=L)}function Me(L,le,te){te===void 0&&(he===null?te=s.TEXTURE0+H-1:te=he);let de=re[te];de===void 0&&(de={type:void 0,texture:void 0},re[te]=de),(de.type!==L||de.texture!==le)&&(he!==te&&(s.activeTexture(te),he=te),s.bindTexture(L,le||X[L]),de.type=L,de.texture=le)}function T(){const L=re[he];L!==void 0&&L.type!==void 0&&(s.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function _(){try{s.compressedTexImage2D(...arguments)}catch(L){Ie("WebGLState:",L)}}function I(){try{s.compressedTexImage3D(...arguments)}catch(L){Ie("WebGLState:",L)}}function q(){try{s.texSubImage2D(...arguments)}catch(L){Ie("WebGLState:",L)}}function j(){try{s.texSubImage3D(...arguments)}catch(L){Ie("WebGLState:",L)}}function W(){try{s.compressedTexSubImage2D(...arguments)}catch(L){Ie("WebGLState:",L)}}function ne(){try{s.compressedTexSubImage3D(...arguments)}catch(L){Ie("WebGLState:",L)}}function ie(){try{s.texStorage2D(...arguments)}catch(L){Ie("WebGLState:",L)}}function pe(){try{s.texStorage3D(...arguments)}catch(L){Ie("WebGLState:",L)}}function Ae(){try{s.texImage2D(...arguments)}catch(L){Ie("WebGLState:",L)}}function J(){try{s.texImage3D(...arguments)}catch(L){Ie("WebGLState:",L)}}function ae(L){Ee.equals(L)===!1&&(s.scissor(L.x,L.y,L.z,L.w),Ee.copy(L))}function ge(L){Ve.equals(L)===!1&&(s.viewport(L.x,L.y,L.z,L.w),Ve.copy(L))}function ye(L,le){let te=c.get(le);te===void 0&&(te=new WeakMap,c.set(le,te));let de=te.get(L);de===void 0&&(de=s.getUniformBlockIndex(le,L.name),te.set(L,de))}function oe(L,le){const de=c.get(le).get(L);l.get(le)!==de&&(s.uniformBlockBinding(le,de,L.__bindingPointIndex),l.set(le,de))}function Ue(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),a.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),h={},he=null,re={},u={},d=new WeakMap,f=[],g=null,x=!1,m=null,p=null,E=null,M=null,b=null,A=null,w=null,R=new De(0,0,0),U=0,v=!1,y=null,P=null,G=null,V=null,Y=null,Ee.set(0,0,s.canvas.width,s.canvas.height),Ve.set(0,0,s.canvas.width,s.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:Z,disable:me,bindFramebuffer:Ce,drawBuffers:ve,useProgram:Ye,setBlending:Ke,setMaterial:Je,setFlipSided:Ne,setCullFace:dt,setLineWidth:C,setPolygonOffset:ft,setScissorTest:je,activeTexture:st,bindTexture:Me,unbindTexture:T,compressedTexImage2D:_,compressedTexImage3D:I,texImage2D:Ae,texImage3D:J,updateUBOMapping:ye,uniformBlockBinding:oe,texStorage2D:ie,texStorage3D:pe,texSubImage2D:q,texSubImage3D:j,compressedTexSubImage2D:W,compressedTexSubImage3D:ne,scissor:ae,viewport:ge,reset:Ue}}function g_(s,e,t,n,i,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Xe,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(T,_){return f?new OffscreenCanvas(T,_):ls("canvas")}function x(T,_,I){let q=1;const j=Me(T);if((j.width>I||j.height>I)&&(q=I/Math.max(j.width,j.height)),q<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const W=Math.floor(q*j.width),ne=Math.floor(q*j.height);u===void 0&&(u=g(W,ne));const ie=_?g(W,ne):u;return ie.width=W,ie.height=ne,ie.getContext("2d").drawImage(T,0,0,W,ne),Te("WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+W+"x"+ne+")."),ie}else return"data"in T&&Te("WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),T;return T}function m(T){return T.generateMipmaps}function p(T){s.generateMipmap(T)}function E(T){return T.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?s.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function M(T,_,I,q,j=!1){if(T!==null){if(s[T]!==void 0)return s[T];Te("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let W=_;if(_===s.RED&&(I===s.FLOAT&&(W=s.R32F),I===s.HALF_FLOAT&&(W=s.R16F),I===s.UNSIGNED_BYTE&&(W=s.R8)),_===s.RED_INTEGER&&(I===s.UNSIGNED_BYTE&&(W=s.R8UI),I===s.UNSIGNED_SHORT&&(W=s.R16UI),I===s.UNSIGNED_INT&&(W=s.R32UI),I===s.BYTE&&(W=s.R8I),I===s.SHORT&&(W=s.R16I),I===s.INT&&(W=s.R32I)),_===s.RG&&(I===s.FLOAT&&(W=s.RG32F),I===s.HALF_FLOAT&&(W=s.RG16F),I===s.UNSIGNED_BYTE&&(W=s.RG8)),_===s.RG_INTEGER&&(I===s.UNSIGNED_BYTE&&(W=s.RG8UI),I===s.UNSIGNED_SHORT&&(W=s.RG16UI),I===s.UNSIGNED_INT&&(W=s.RG32UI),I===s.BYTE&&(W=s.RG8I),I===s.SHORT&&(W=s.RG16I),I===s.INT&&(W=s.RG32I)),_===s.RGB_INTEGER&&(I===s.UNSIGNED_BYTE&&(W=s.RGB8UI),I===s.UNSIGNED_SHORT&&(W=s.RGB16UI),I===s.UNSIGNED_INT&&(W=s.RGB32UI),I===s.BYTE&&(W=s.RGB8I),I===s.SHORT&&(W=s.RGB16I),I===s.INT&&(W=s.RGB32I)),_===s.RGBA_INTEGER&&(I===s.UNSIGNED_BYTE&&(W=s.RGBA8UI),I===s.UNSIGNED_SHORT&&(W=s.RGBA16UI),I===s.UNSIGNED_INT&&(W=s.RGBA32UI),I===s.BYTE&&(W=s.RGBA8I),I===s.SHORT&&(W=s.RGBA16I),I===s.INT&&(W=s.RGBA32I)),_===s.RGB&&(I===s.UNSIGNED_INT_5_9_9_9_REV&&(W=s.RGB9_E5),I===s.UNSIGNED_INT_10F_11F_11F_REV&&(W=s.R11F_G11F_B10F)),_===s.RGBA){const ne=j?tr:qe.getTransfer(q);I===s.FLOAT&&(W=s.RGBA32F),I===s.HALF_FLOAT&&(W=s.RGBA16F),I===s.UNSIGNED_BYTE&&(W=ne===tt?s.SRGB8_ALPHA8:s.RGBA8),I===s.UNSIGNED_SHORT_4_4_4_4&&(W=s.RGBA4),I===s.UNSIGNED_SHORT_5_5_5_1&&(W=s.RGB5_A1)}return(W===s.R16F||W===s.R32F||W===s.RG16F||W===s.RG32F||W===s.RGBA16F||W===s.RGBA32F)&&e.get("EXT_color_buffer_float"),W}function b(T,_){let I;return T?_===null||_===dn||_===rs?I=s.DEPTH24_STENCIL8:_===Yt?I=s.DEPTH32F_STENCIL8:_===ss&&(I=s.DEPTH24_STENCIL8,Te("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===dn||_===rs?I=s.DEPTH_COMPONENT24:_===Yt?I=s.DEPTH_COMPONENT32F:_===ss&&(I=s.DEPTH_COMPONENT16),I}function A(T,_){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==vt&&T.minFilter!==St?Math.log2(Math.max(_.width,_.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?_.mipmaps.length:1}function w(T){const _=T.target;_.removeEventListener("dispose",w),U(_),_.isVideoTexture&&h.delete(_)}function R(T){const _=T.target;_.removeEventListener("dispose",R),y(_)}function U(T){const _=n.get(T);if(_.__webglInit===void 0)return;const I=T.source,q=d.get(I);if(q){const j=q[_.__cacheKey];j.usedTimes--,j.usedTimes===0&&v(T),Object.keys(q).length===0&&d.delete(I)}n.remove(T)}function v(T){const _=n.get(T);s.deleteTexture(_.__webglTexture);const I=T.source,q=d.get(I);delete q[_.__cacheKey],a.memory.textures--}function y(T){const _=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(_.__webglFramebuffer[q]))for(let j=0;j<_.__webglFramebuffer[q].length;j++)s.deleteFramebuffer(_.__webglFramebuffer[q][j]);else s.deleteFramebuffer(_.__webglFramebuffer[q]);_.__webglDepthbuffer&&s.deleteRenderbuffer(_.__webglDepthbuffer[q])}else{if(Array.isArray(_.__webglFramebuffer))for(let q=0;q<_.__webglFramebuffer.length;q++)s.deleteFramebuffer(_.__webglFramebuffer[q]);else s.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&s.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&s.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let q=0;q<_.__webglColorRenderbuffer.length;q++)_.__webglColorRenderbuffer[q]&&s.deleteRenderbuffer(_.__webglColorRenderbuffer[q]);_.__webglDepthRenderbuffer&&s.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const I=T.textures;for(let q=0,j=I.length;q<j;q++){const W=n.get(I[q]);W.__webglTexture&&(s.deleteTexture(W.__webglTexture),a.memory.textures--),n.remove(I[q])}n.remove(T)}let P=0;function G(){P=0}function V(){const T=P;return T>=i.maxTextures&&Te("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+i.maxTextures),P+=1,T}function Y(T){const _=[];return _.push(T.wrapS),_.push(T.wrapT),_.push(T.wrapR||0),_.push(T.magFilter),_.push(T.minFilter),_.push(T.anisotropy),_.push(T.internalFormat),_.push(T.format),_.push(T.type),_.push(T.generateMipmaps),_.push(T.premultiplyAlpha),_.push(T.flipY),_.push(T.unpackAlignment),_.push(T.colorSpace),_.join()}function H(T,_){const I=n.get(T);if(T.isVideoTexture&&je(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&I.__version!==T.version){const q=T.image;if(q===null)Te("WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)Te("WebGLRenderer: Texture marked for update but image is incomplete");else{X(I,T,_);return}}else T.isExternalTexture&&(I.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(s.TEXTURE_2D,I.__webglTexture,s.TEXTURE0+_)}function O(T,_){const I=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&I.__version!==T.version){X(I,T,_);return}else T.isExternalTexture&&(I.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(s.TEXTURE_2D_ARRAY,I.__webglTexture,s.TEXTURE0+_)}function B(T,_){const I=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&I.__version!==T.version){X(I,T,_);return}t.bindTexture(s.TEXTURE_3D,I.__webglTexture,s.TEXTURE0+_)}function $(T,_){const I=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&I.__version!==T.version){Z(I,T,_);return}t.bindTexture(s.TEXTURE_CUBE_MAP,I.__webglTexture,s.TEXTURE0+_)}const he={[wi]:s.REPEAT,[on]:s.CLAMP_TO_EDGE,[er]:s.MIRRORED_REPEAT},re={[vt]:s.NEAREST,[_c]:s.NEAREST_MIPMAP_NEAREST,[Ji]:s.NEAREST_MIPMAP_LINEAR,[St]:s.LINEAR,[Ys]:s.LINEAR_MIPMAP_NEAREST,[En]:s.LINEAR_MIPMAP_LINEAR},Q={[Xh]:s.NEVER,[$h]:s.ALWAYS,[qh]:s.LESS,[so]:s.LEQUAL,[Yh]:s.EQUAL,[ro]:s.GEQUAL,[Kh]:s.GREATER,[jh]:s.NOTEQUAL};function xe(T,_){if(_.type===Yt&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===St||_.magFilter===Ys||_.magFilter===Ji||_.magFilter===En||_.minFilter===St||_.minFilter===Ys||_.minFilter===Ji||_.minFilter===En)&&Te("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(T,s.TEXTURE_WRAP_S,he[_.wrapS]),s.texParameteri(T,s.TEXTURE_WRAP_T,he[_.wrapT]),(T===s.TEXTURE_3D||T===s.TEXTURE_2D_ARRAY)&&s.texParameteri(T,s.TEXTURE_WRAP_R,he[_.wrapR]),s.texParameteri(T,s.TEXTURE_MAG_FILTER,re[_.magFilter]),s.texParameteri(T,s.TEXTURE_MIN_FILTER,re[_.minFilter]),_.compareFunction&&(s.texParameteri(T,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(T,s.TEXTURE_COMPARE_FUNC,Q[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===vt||_.minFilter!==Ji&&_.minFilter!==En||_.type===Yt&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const I=e.get("EXT_texture_filter_anisotropic");s.texParameterf(T,I.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,i.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function Ee(T,_){let I=!1;T.__webglInit===void 0&&(T.__webglInit=!0,_.addEventListener("dispose",w));const q=_.source;let j=d.get(q);j===void 0&&(j={},d.set(q,j));const W=Y(_);if(W!==T.__cacheKey){j[W]===void 0&&(j[W]={texture:s.createTexture(),usedTimes:0},a.memory.textures++,I=!0),j[W].usedTimes++;const ne=j[T.__cacheKey];ne!==void 0&&(j[T.__cacheKey].usedTimes--,ne.usedTimes===0&&v(_)),T.__cacheKey=W,T.__webglTexture=j[W].texture}return I}function Ve(T,_,I){return Math.floor(Math.floor(T/I)/_)}function He(T,_,I,q){const W=T.updateRanges;if(W.length===0)t.texSubImage2D(s.TEXTURE_2D,0,0,0,_.width,_.height,I,q,_.data);else{W.sort((J,ae)=>J.start-ae.start);let ne=0;for(let J=1;J<W.length;J++){const ae=W[ne],ge=W[J],ye=ae.start+ae.count,oe=Ve(ge.start,_.width,4),Ue=Ve(ae.start,_.width,4);ge.start<=ye+1&&oe===Ue&&Ve(ge.start+ge.count-1,_.width,4)===oe?ae.count=Math.max(ae.count,ge.start+ge.count-ae.start):(++ne,W[ne]=ge)}W.length=ne+1;const ie=s.getParameter(s.UNPACK_ROW_LENGTH),pe=s.getParameter(s.UNPACK_SKIP_PIXELS),Ae=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,_.width);for(let J=0,ae=W.length;J<ae;J++){const ge=W[J],ye=Math.floor(ge.start/4),oe=Math.ceil(ge.count/4),Ue=ye%_.width,L=Math.floor(ye/_.width),le=oe,te=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,Ue),s.pixelStorei(s.UNPACK_SKIP_ROWS,L),t.texSubImage2D(s.TEXTURE_2D,0,Ue,L,le,te,I,q,_.data)}T.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,ie),s.pixelStorei(s.UNPACK_SKIP_PIXELS,pe),s.pixelStorei(s.UNPACK_SKIP_ROWS,Ae)}}function X(T,_,I){let q=s.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(q=s.TEXTURE_2D_ARRAY),_.isData3DTexture&&(q=s.TEXTURE_3D);const j=Ee(T,_),W=_.source;t.bindTexture(q,T.__webglTexture,s.TEXTURE0+I);const ne=n.get(W);if(W.version!==ne.__version||j===!0){t.activeTexture(s.TEXTURE0+I);const ie=qe.getPrimaries(qe.workingColorSpace),pe=_.colorSpace===Vn?null:qe.getPrimaries(_.colorSpace),Ae=_.colorSpace===Vn||ie===pe?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,_.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,_.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ae);let J=x(_.image,!1,i.maxTextureSize);J=st(_,J);const ae=r.convert(_.format,_.colorSpace),ge=r.convert(_.type);let ye=M(_.internalFormat,ae,ge,_.colorSpace,_.isVideoTexture);xe(q,_);let oe;const Ue=_.mipmaps,L=_.isVideoTexture!==!0,le=ne.__version===void 0||j===!0,te=W.dataReady,de=A(_,J);if(_.isDepthTexture)ye=b(_.format===ni,_.type),le&&(L?t.texStorage2D(s.TEXTURE_2D,1,ye,J.width,J.height):t.texImage2D(s.TEXTURE_2D,0,ye,J.width,J.height,0,ae,ge,null));else if(_.isDataTexture)if(Ue.length>0){L&&le&&t.texStorage2D(s.TEXTURE_2D,de,ye,Ue[0].width,Ue[0].height);for(let ee=0,K=Ue.length;ee<K;ee++)oe=Ue[ee],L?te&&t.texSubImage2D(s.TEXTURE_2D,ee,0,0,oe.width,oe.height,ae,ge,oe.data):t.texImage2D(s.TEXTURE_2D,ee,ye,oe.width,oe.height,0,ae,ge,oe.data);_.generateMipmaps=!1}else L?(le&&t.texStorage2D(s.TEXTURE_2D,de,ye,J.width,J.height),te&&He(_,J,ae,ge)):t.texImage2D(s.TEXTURE_2D,0,ye,J.width,J.height,0,ae,ge,J.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){L&&le&&t.texStorage3D(s.TEXTURE_2D_ARRAY,de,ye,Ue[0].width,Ue[0].height,J.depth);for(let ee=0,K=Ue.length;ee<K;ee++)if(oe=Ue[ee],_.format!==Kt)if(ae!==null)if(L){if(te)if(_.layerUpdates.size>0){const se=bl(oe.width,oe.height,_.format,_.type);for(const Pe of _.layerUpdates){const Qe=oe.data.subarray(Pe*se/oe.data.BYTES_PER_ELEMENT,(Pe+1)*se/oe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,ee,0,0,Pe,oe.width,oe.height,1,ae,Qe)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,ee,0,0,0,oe.width,oe.height,J.depth,ae,oe.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,ee,ye,oe.width,oe.height,J.depth,0,oe.data,0,0);else Te("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else L?te&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,ee,0,0,0,oe.width,oe.height,J.depth,ae,ge,oe.data):t.texImage3D(s.TEXTURE_2D_ARRAY,ee,ye,oe.width,oe.height,J.depth,0,ae,ge,oe.data)}else{L&&le&&t.texStorage2D(s.TEXTURE_2D,de,ye,Ue[0].width,Ue[0].height);for(let ee=0,K=Ue.length;ee<K;ee++)oe=Ue[ee],_.format!==Kt?ae!==null?L?te&&t.compressedTexSubImage2D(s.TEXTURE_2D,ee,0,0,oe.width,oe.height,ae,oe.data):t.compressedTexImage2D(s.TEXTURE_2D,ee,ye,oe.width,oe.height,0,oe.data):Te("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?te&&t.texSubImage2D(s.TEXTURE_2D,ee,0,0,oe.width,oe.height,ae,ge,oe.data):t.texImage2D(s.TEXTURE_2D,ee,ye,oe.width,oe.height,0,ae,ge,oe.data)}else if(_.isDataArrayTexture)if(L){if(le&&t.texStorage3D(s.TEXTURE_2D_ARRAY,de,ye,J.width,J.height,J.depth),te)if(_.layerUpdates.size>0){const ee=bl(J.width,J.height,_.format,_.type);for(const K of _.layerUpdates){const se=J.data.subarray(K*ee/J.data.BYTES_PER_ELEMENT,(K+1)*ee/J.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,K,J.width,J.height,1,ae,ge,se)}_.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,ae,ge,J.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,ye,J.width,J.height,J.depth,0,ae,ge,J.data);else if(_.isData3DTexture)L?(le&&t.texStorage3D(s.TEXTURE_3D,de,ye,J.width,J.height,J.depth),te&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,ae,ge,J.data)):t.texImage3D(s.TEXTURE_3D,0,ye,J.width,J.height,J.depth,0,ae,ge,J.data);else if(_.isFramebufferTexture){if(le)if(L)t.texStorage2D(s.TEXTURE_2D,de,ye,J.width,J.height);else{let ee=J.width,K=J.height;for(let se=0;se<de;se++)t.texImage2D(s.TEXTURE_2D,se,ye,ee,K,0,ae,ge,null),ee>>=1,K>>=1}}else if(Ue.length>0){if(L&&le){const ee=Me(Ue[0]);t.texStorage2D(s.TEXTURE_2D,de,ye,ee.width,ee.height)}for(let ee=0,K=Ue.length;ee<K;ee++)oe=Ue[ee],L?te&&t.texSubImage2D(s.TEXTURE_2D,ee,0,0,ae,ge,oe):t.texImage2D(s.TEXTURE_2D,ee,ye,ae,ge,oe);_.generateMipmaps=!1}else if(L){if(le){const ee=Me(J);t.texStorage2D(s.TEXTURE_2D,de,ye,ee.width,ee.height)}te&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,ae,ge,J)}else t.texImage2D(s.TEXTURE_2D,0,ye,ae,ge,J);m(_)&&p(q),ne.__version=W.version,_.onUpdate&&_.onUpdate(_)}T.__version=_.version}function Z(T,_,I){if(_.image.length!==6)return;const q=Ee(T,_),j=_.source;t.bindTexture(s.TEXTURE_CUBE_MAP,T.__webglTexture,s.TEXTURE0+I);const W=n.get(j);if(j.version!==W.__version||q===!0){t.activeTexture(s.TEXTURE0+I);const ne=qe.getPrimaries(qe.workingColorSpace),ie=_.colorSpace===Vn?null:qe.getPrimaries(_.colorSpace),pe=_.colorSpace===Vn||ne===ie?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,_.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,_.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,pe);const Ae=_.isCompressedTexture||_.image[0].isCompressedTexture,J=_.image[0]&&_.image[0].isDataTexture,ae=[];for(let K=0;K<6;K++)!Ae&&!J?ae[K]=x(_.image[K],!0,i.maxCubemapSize):ae[K]=J?_.image[K].image:_.image[K],ae[K]=st(_,ae[K]);const ge=ae[0],ye=r.convert(_.format,_.colorSpace),oe=r.convert(_.type),Ue=M(_.internalFormat,ye,oe,_.colorSpace),L=_.isVideoTexture!==!0,le=W.__version===void 0||q===!0,te=j.dataReady;let de=A(_,ge);xe(s.TEXTURE_CUBE_MAP,_);let ee;if(Ae){L&&le&&t.texStorage2D(s.TEXTURE_CUBE_MAP,de,Ue,ge.width,ge.height);for(let K=0;K<6;K++){ee=ae[K].mipmaps;for(let se=0;se<ee.length;se++){const Pe=ee[se];_.format!==Kt?ye!==null?L?te&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,se,0,0,Pe.width,Pe.height,ye,Pe.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,se,Ue,Pe.width,Pe.height,0,Pe.data):Te("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?te&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,se,0,0,Pe.width,Pe.height,ye,oe,Pe.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,se,Ue,Pe.width,Pe.height,0,ye,oe,Pe.data)}}}else{if(ee=_.mipmaps,L&&le){ee.length>0&&de++;const K=Me(ae[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,de,Ue,K.width,K.height)}for(let K=0;K<6;K++)if(J){L?te&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,ae[K].width,ae[K].height,ye,oe,ae[K].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ue,ae[K].width,ae[K].height,0,ye,oe,ae[K].data);for(let se=0;se<ee.length;se++){const Qe=ee[se].image[K].image;L?te&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,se+1,0,0,Qe.width,Qe.height,ye,oe,Qe.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,se+1,Ue,Qe.width,Qe.height,0,ye,oe,Qe.data)}}else{L?te&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,ye,oe,ae[K]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ue,ye,oe,ae[K]);for(let se=0;se<ee.length;se++){const Pe=ee[se];L?te&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,se+1,0,0,ye,oe,Pe.image[K]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,se+1,Ue,ye,oe,Pe.image[K])}}}m(_)&&p(s.TEXTURE_CUBE_MAP),W.__version=j.version,_.onUpdate&&_.onUpdate(_)}T.__version=_.version}function me(T,_,I,q,j,W){const ne=r.convert(I.format,I.colorSpace),ie=r.convert(I.type),pe=M(I.internalFormat,ne,ie,I.colorSpace),Ae=n.get(_),J=n.get(I);if(J.__renderTarget=_,!Ae.__hasExternalTextures){const ae=Math.max(1,_.width>>W),ge=Math.max(1,_.height>>W);j===s.TEXTURE_3D||j===s.TEXTURE_2D_ARRAY?t.texImage3D(j,W,pe,ae,ge,_.depth,0,ne,ie,null):t.texImage2D(j,W,pe,ae,ge,0,ne,ie,null)}t.bindFramebuffer(s.FRAMEBUFFER,T),ft(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,q,j,J.__webglTexture,0,C(_)):(j===s.TEXTURE_2D||j>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,q,j,J.__webglTexture,W),t.bindFramebuffer(s.FRAMEBUFFER,null)}function Ce(T,_,I){if(s.bindRenderbuffer(s.RENDERBUFFER,T),_.depthBuffer){const q=_.depthTexture,j=q&&q.isDepthTexture?q.type:null,W=b(_.stencilBuffer,j),ne=_.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;ft(_)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,C(_),W,_.width,_.height):I?s.renderbufferStorageMultisample(s.RENDERBUFFER,C(_),W,_.width,_.height):s.renderbufferStorage(s.RENDERBUFFER,W,_.width,_.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,ne,s.RENDERBUFFER,T)}else{const q=_.textures;for(let j=0;j<q.length;j++){const W=q[j],ne=r.convert(W.format,W.colorSpace),ie=r.convert(W.type),pe=M(W.internalFormat,ne,ie,W.colorSpace);ft(_)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,C(_),pe,_.width,_.height):I?s.renderbufferStorageMultisample(s.RENDERBUFFER,C(_),pe,_.width,_.height):s.renderbufferStorage(s.RENDERBUFFER,pe,_.width,_.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function ve(T,_,I){const q=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(s.FRAMEBUFFER,T),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const j=n.get(_.depthTexture);if(j.__renderTarget=_,(!j.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),q){if(j.__webglInit===void 0&&(j.__webglInit=!0,_.depthTexture.addEventListener("dispose",w)),j.__webglTexture===void 0){j.__webglTexture=s.createTexture(),t.bindTexture(s.TEXTURE_CUBE_MAP,j.__webglTexture),xe(s.TEXTURE_CUBE_MAP,_.depthTexture);const Ae=r.convert(_.depthTexture.format),J=r.convert(_.depthTexture.type);let ae;_.depthTexture.format===Pn?ae=s.DEPTH_COMPONENT24:_.depthTexture.format===ni&&(ae=s.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)s.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,ae,_.width,_.height,0,Ae,J,null)}}else H(_.depthTexture,0);const W=j.__webglTexture,ne=C(_),ie=q?s.TEXTURE_CUBE_MAP_POSITIVE_X+I:s.TEXTURE_2D,pe=_.depthTexture.format===ni?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;if(_.depthTexture.format===Pn)ft(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,pe,ie,W,0,ne):s.framebufferTexture2D(s.FRAMEBUFFER,pe,ie,W,0);else if(_.depthTexture.format===ni)ft(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,pe,ie,W,0,ne):s.framebufferTexture2D(s.FRAMEBUFFER,pe,ie,W,0);else throw new Error("Unknown depthTexture format")}function Ye(T){const _=n.get(T),I=T.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==T.depthTexture){const q=T.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),q){const j=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,q.removeEventListener("dispose",j)};q.addEventListener("dispose",j),_.__depthDisposeCallback=j}_.__boundDepthTexture=q}if(T.depthTexture&&!_.__autoAllocateDepthBuffer)if(I)for(let q=0;q<6;q++)ve(_.__webglFramebuffer[q],T,q);else{const q=T.texture.mipmaps;q&&q.length>0?ve(_.__webglFramebuffer[0],T,0):ve(_.__webglFramebuffer,T,0)}else if(I){_.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer[q]),_.__webglDepthbuffer[q]===void 0)_.__webglDepthbuffer[q]=s.createRenderbuffer(),Ce(_.__webglDepthbuffer[q],T,!1);else{const j=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,W=_.__webglDepthbuffer[q];s.bindRenderbuffer(s.RENDERBUFFER,W),s.framebufferRenderbuffer(s.FRAMEBUFFER,j,s.RENDERBUFFER,W)}}else{const q=T.texture.mipmaps;if(q&&q.length>0?t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=s.createRenderbuffer(),Ce(_.__webglDepthbuffer,T,!1);else{const j=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,W=_.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,W),s.framebufferRenderbuffer(s.FRAMEBUFFER,j,s.RENDERBUFFER,W)}}t.bindFramebuffer(s.FRAMEBUFFER,null)}function ot(T,_,I){const q=n.get(T);_!==void 0&&me(q.__webglFramebuffer,T,T.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),I!==void 0&&Ye(T)}function Fe(T){const _=T.texture,I=n.get(T),q=n.get(_);T.addEventListener("dispose",R);const j=T.textures,W=T.isWebGLCubeRenderTarget===!0,ne=j.length>1;if(ne||(q.__webglTexture===void 0&&(q.__webglTexture=s.createTexture()),q.__version=_.version,a.memory.textures++),W){I.__webglFramebuffer=[];for(let ie=0;ie<6;ie++)if(_.mipmaps&&_.mipmaps.length>0){I.__webglFramebuffer[ie]=[];for(let pe=0;pe<_.mipmaps.length;pe++)I.__webglFramebuffer[ie][pe]=s.createFramebuffer()}else I.__webglFramebuffer[ie]=s.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){I.__webglFramebuffer=[];for(let ie=0;ie<_.mipmaps.length;ie++)I.__webglFramebuffer[ie]=s.createFramebuffer()}else I.__webglFramebuffer=s.createFramebuffer();if(ne)for(let ie=0,pe=j.length;ie<pe;ie++){const Ae=n.get(j[ie]);Ae.__webglTexture===void 0&&(Ae.__webglTexture=s.createTexture(),a.memory.textures++)}if(T.samples>0&&ft(T)===!1){I.__webglMultisampledFramebuffer=s.createFramebuffer(),I.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let ie=0;ie<j.length;ie++){const pe=j[ie];I.__webglColorRenderbuffer[ie]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,I.__webglColorRenderbuffer[ie]);const Ae=r.convert(pe.format,pe.colorSpace),J=r.convert(pe.type),ae=M(pe.internalFormat,Ae,J,pe.colorSpace,T.isXRRenderTarget===!0),ge=C(T);s.renderbufferStorageMultisample(s.RENDERBUFFER,ge,ae,T.width,T.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ie,s.RENDERBUFFER,I.__webglColorRenderbuffer[ie])}s.bindRenderbuffer(s.RENDERBUFFER,null),T.depthBuffer&&(I.__webglDepthRenderbuffer=s.createRenderbuffer(),Ce(I.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(W){t.bindTexture(s.TEXTURE_CUBE_MAP,q.__webglTexture),xe(s.TEXTURE_CUBE_MAP,_);for(let ie=0;ie<6;ie++)if(_.mipmaps&&_.mipmaps.length>0)for(let pe=0;pe<_.mipmaps.length;pe++)me(I.__webglFramebuffer[ie][pe],T,_,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ie,pe);else me(I.__webglFramebuffer[ie],T,_,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0);m(_)&&p(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ne){for(let ie=0,pe=j.length;ie<pe;ie++){const Ae=j[ie],J=n.get(Ae);let ae=s.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ae=T.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(ae,J.__webglTexture),xe(ae,Ae),me(I.__webglFramebuffer,T,Ae,s.COLOR_ATTACHMENT0+ie,ae,0),m(Ae)&&p(ae)}t.unbindTexture()}else{let ie=s.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ie=T.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(ie,q.__webglTexture),xe(ie,_),_.mipmaps&&_.mipmaps.length>0)for(let pe=0;pe<_.mipmaps.length;pe++)me(I.__webglFramebuffer[pe],T,_,s.COLOR_ATTACHMENT0,ie,pe);else me(I.__webglFramebuffer,T,_,s.COLOR_ATTACHMENT0,ie,0);m(_)&&p(ie),t.unbindTexture()}T.depthBuffer&&Ye(T)}function Ke(T){const _=T.textures;for(let I=0,q=_.length;I<q;I++){const j=_[I];if(m(j)){const W=E(T),ne=n.get(j).__webglTexture;t.bindTexture(W,ne),p(W),t.unbindTexture()}}}const Je=[],Ne=[];function dt(T){if(T.samples>0){if(ft(T)===!1){const _=T.textures,I=T.width,q=T.height;let j=s.COLOR_BUFFER_BIT;const W=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ne=n.get(T),ie=_.length>1;if(ie)for(let Ae=0;Ae<_.length;Ae++)t.bindFramebuffer(s.FRAMEBUFFER,ne.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ae,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,ne.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ae,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,ne.__webglMultisampledFramebuffer);const pe=T.texture.mipmaps;pe&&pe.length>0?t.bindFramebuffer(s.DRAW_FRAMEBUFFER,ne.__webglFramebuffer[0]):t.bindFramebuffer(s.DRAW_FRAMEBUFFER,ne.__webglFramebuffer);for(let Ae=0;Ae<_.length;Ae++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(j|=s.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(j|=s.STENCIL_BUFFER_BIT)),ie){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,ne.__webglColorRenderbuffer[Ae]);const J=n.get(_[Ae]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,J,0)}s.blitFramebuffer(0,0,I,q,0,0,I,q,j,s.NEAREST),l===!0&&(Je.length=0,Ne.length=0,Je.push(s.COLOR_ATTACHMENT0+Ae),T.depthBuffer&&T.resolveDepthBuffer===!1&&(Je.push(W),Ne.push(W),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Ne)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Je))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),ie)for(let Ae=0;Ae<_.length;Ae++){t.bindFramebuffer(s.FRAMEBUFFER,ne.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ae,s.RENDERBUFFER,ne.__webglColorRenderbuffer[Ae]);const J=n.get(_[Ae]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,ne.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ae,s.TEXTURE_2D,J,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,ne.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const _=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[_])}}}function C(T){return Math.min(i.maxSamples,T.samples)}function ft(T){const _=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function je(T){const _=a.render.frame;h.get(T)!==_&&(h.set(T,_),T.update())}function st(T,_){const I=T.colorSpace,q=T.format,j=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||I!==Dt&&I!==Vn&&(qe.getTransfer(I)===tt?(q!==Kt||j!==Ht)&&Te("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ie("WebGLTextures: Unsupported texture color space:",I)),_}function Me(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=V,this.resetTextureUnits=G,this.setTexture2D=H,this.setTexture2DArray=O,this.setTexture3D=B,this.setTextureCube=$,this.rebindTextures=ot,this.setupRenderTarget=Fe,this.updateRenderTargetMipmap=Ke,this.updateMultisampleRenderTarget=dt,this.setupDepthRenderbuffer=Ye,this.setupFrameBufferTexture=me,this.useMultisampledRTT=ft,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function __(s,e){function t(n,i=Vn){let r;const a=qe.getTransfer(i);if(n===Ht)return s.UNSIGNED_BYTE;if(n===Ja)return s.UNSIGNED_SHORT_4_4_4_4;if(n===Qa)return s.UNSIGNED_SHORT_5_5_5_1;if(n===Sc)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Mc)return s.UNSIGNED_INT_10F_11F_11F_REV;if(n===xc)return s.BYTE;if(n===vc)return s.SHORT;if(n===ss)return s.UNSIGNED_SHORT;if(n===Za)return s.INT;if(n===dn)return s.UNSIGNED_INT;if(n===Yt)return s.FLOAT;if(n===Cn)return s.HALF_FLOAT;if(n===yc)return s.ALPHA;if(n===bc)return s.RGB;if(n===Kt)return s.RGBA;if(n===Pn)return s.DEPTH_COMPONENT;if(n===ni)return s.DEPTH_STENCIL;if(n===eo)return s.RED;if(n===to)return s.RED_INTEGER;if(n===Ri)return s.RG;if(n===no)return s.RG_INTEGER;if(n===io)return s.RGBA_INTEGER;if(n===Ks||n===js||n===$s||n===Zs)if(a===tt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Ks)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===js)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===$s)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Zs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Ks)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===js)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===$s)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Zs)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ca||n===ha||n===ua||n===da)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===ca)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ha)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ua)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===da)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===fa||n===pa||n===ma||n===ga||n===_a||n===xa||n===va)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===fa||n===pa)return a===tt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===ma)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===ga)return r.COMPRESSED_R11_EAC;if(n===_a)return r.COMPRESSED_SIGNED_R11_EAC;if(n===xa)return r.COMPRESSED_RG11_EAC;if(n===va)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Sa||n===Ma||n===ya||n===ba||n===Ea||n===Ta||n===Aa||n===wa||n===Ra||n===Ca||n===Pa||n===La||n===Ia||n===Da)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Sa)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ma)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ya)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ba)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ea)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ta)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Aa)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===wa)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ra)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ca)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Pa)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===La)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ia)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Da)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Na||n===Ua||n===Fa)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Na)return a===tt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Ua)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Fa)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Oa||n===Ba||n===za||n===Va)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Oa)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ba)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===za)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Va)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===rs?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}const x_=`
void main() {
